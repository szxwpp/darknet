...
for weight_file in os.listdir(weight_dir):
    if 'weights' in weight_file:
        ...
        if log_file in evaled_files:
            ...
            eval_cmd = 'cd ../../ \n ./darknet detector map %s %s %s -dont_show 2>&1 | tee %s' % (
            data_path, cfg_path, full_weight_file, full_log_file)
